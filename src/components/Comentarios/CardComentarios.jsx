...
import imagenicono2 from "../../assets/Images/iconouser.jpg";
 ...
 const CardComentarios = () => {
  return (
    ...
    <br />
        <Card className="cardcomentario col-sm-12 col-md-6 col-lg-4 d-inline-block align-content-center bg-light">
        <img
          className=""
      ...
      <Card className="cardcomentario col-sm-12 col-md-6 col-lg-4 d-inline-block align-content-center bg-light">
        ...
        <Card.Body className="p-3">
          <div className="cardcomentario2 mb-1">
            <Card.Title className="text-center align-content-center mb-0">Lionel Messi</Card.Title>
            <Card.Subtitle className="text-muted text-center nombrecomentarios">
              @Leomessi10 | 4H
            </Card.Subtitle>
          </div>
