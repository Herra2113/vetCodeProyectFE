    ...
    <div className="container-fluid d-flex" id="contenedorcomentarios">
      ...
      <Card className="cardcomentario col-sm-12 col-md-6 col-lg-4">
        ...
        <Card.Body className="p-3">
          ...
          <Card.Text>
            Muy buena la atencion, excelente trato de los Veterinarios, muy profesionales. Por cierto, buena pagina!
          </Card.Text>
        </Card.Body>
      </Card>
      ...
      <Card className="cardcomentario col-sm-12 col-md-6 col-lg-4">
        ...
        <Card.Body className="p-3">
          ...
          <Card.Text>Espetacular la pagina, che. ¡Muy linda!</Card.Text>
        </Card.Body>
      </Card>
